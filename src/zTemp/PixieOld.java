...
//La clase PixieOld es un Sprite animado, pero puede usarse para dibujar imagenes estaticas tambien
public class PixieOld extends Actor
{
    ...
    public PixieOld (TextureRegion texture, int filas, int columnas, int numFramesAnimacion, float duracionFrame, boolean isEnlazado)
    {
        this.isAnimado = true;
        ...
        //una vez calculado aplicamos esas propiedades al Actor PixieOld
    ...
    public PixieOld (TextureRegion texture, int filas, int columnas, int duracionFrame, boolean isEnlazado)
    {   this (texture, filas, columnas, columnas, duracionFrame, isEnlazado); }
    
    public PixieOld (TextureRegion texture, int filas, int columnas)
    {   this (texture, filas, columnas, columnas, MiscData.PIXIE_DuracionFrame_Medio, false);}
    
    public PixieOld (TextureRegion texture, int columnas)
    ...
    public PixieOld (TextureRegion texture)
    {
        frameActual = texture;
        isAnimado = false;
    ...
    //CONSTRUCTOR COPIA, que construye un PixieOld a partir de otro que se pasa como parametro, copiando todos sus datos.
    //Se hace asi puesto que los pixies tienen que ser independientes e instanciados para que no compartan las animaciones
    public PixieOld (PixieOld pixie)
    {
