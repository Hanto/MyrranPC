...
public abstract class AbstractPantalla implements Screen 
{
    ...
    @Override public void show() //El metodo show se ejecuta una solo vez cuando se inicializa la pantalla
    {
    ...
    @Override public void render(float delta) //El metodo render se ejecuta 60 veces por segundo
